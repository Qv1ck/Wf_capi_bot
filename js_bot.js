...
function formatWarframeInfo(info) {
    ...
    if (info.helminth) {
        message += `🧬 *Helminth:*\n`;
        // Показываем название способности из слота варфрейма
        const slotAbility = info.abilities && info.abilities[info.helminth.slot - 1];
        const slotName = typeof slotAbility === 'string' ? slotAbility : (slotAbility?.name || `Слот ${info.helminth.slot}`);
        message += `• ${slotName} → ${info.helminth.ability}\n\n`;
    }
        ...
        syndicates: [
            {
                ...
                rewards: ['Части Гара', 'Части Ревенанта', 'Зау (оружие ближнего боя)', 'Рыболовное снаряжение', 'Декорации'],
                howToRank: 'Задания (баунти) на Равнинах Эйдолона, сдача рыбы и минералов'
            },
            {
                id: 'quills',
                name: 'Перья (Куиллы)',
    ...
    fortuna: {
        ...
        syndicates: [
            ...
            },
            {
                ...
                howToRank: 'Охота на Сферы (Эксплоитер, Грабитель)'
            }
        ]
    },
    deimos: {
        name: '🦠 Деймос',
        location: 'Камбионский Дрейф',
        syndicates: [
            {
                id: 'entrati',
                name: 'Энтрати',
                leader: 'Мать',
                ranks: ['Нейтралитет', 'Знакомый', 'Доверенный', 'Партнёр', 'Семья'],
                rewards: ['Части Ксаку', 'Части Севагота', 'Вульпафила/Преданная', 'Нексифер', 'Криптолитовые моды'],
                howToRank: 'Задания (баунти) на Деймосе, Изоляционные хранилища'
            },
            {
                id: 'necraloid',
                name: 'Некралоид',
                leader: 'Лоид',
                ranks: ['Нейтралитет', 'Помощник', 'Оперативник', 'Союзник', 'Партнёр'],
                rewards: ['Части Бонвиджера', 'Части архана-меха', 'Декорации Некрамеха'],
            ...
            },
            {
                ...
                ranks: ['Посторонний', 'Гость', 'Субъект', 'Образец', 'Семья'],
                rewards: ['Части Квеллор', 'Части Цинтега', 'Инкарнон генезисы', 'Архан оружие'],
                howToRank: 'Глубокие Архивы, задания на Деймосе (Санктум)'
            }
        ]
    },
    zariman: {
        name: '🔮 Зариман',
        location: 'Зариман Десять-Ноль',
        syndicates: [
            {
                id: 'holdfasts',
                name: 'Хранители',
                leader: 'Кавалеро',
                ranks: ['Нейтралитет', 'Безбилетник', 'Гость', 'Обитатель', 'Ангел'],
                rewards: ['Части Гайра', 'Части Воридо', 'Инкарнон генезисы', 'Эволоки'],
                howToRank: 'Задания на Заримане (Каскад, Потоп, Армагеддон), сдача ресурсов'
            }
        ]
    },
    relay: {
        ...
        syndicates: [
            ...
            },
            {
                ...
                leader: 'Арбитр',
                ranks: ['Нейтралитет', 'Ученик', 'Максим', 'Арбитратор', 'Проводник'],
                rewards: ['Аугменты Варфреймов', 'Оружие синдиката', 'Арчвинг моды'],
                howToRank: 'Ношение сигила, задания синдиката, медальоны'
            },
            {
                ...
                name: 'Цефалон Суда',
                leader: 'Суда',
                ranks: ['Нейтралитет', 'Посетитель', 'Запрос', 'Гений', 'Судья'],
                rewards: ['Аугменты Варфреймов', 'Оружие синдиката', 'Арчвинг моды'],
                howToRank: 'Ношение сигила, задания синдиката, медальоны'
            },
            {
            ...
            },
            {
                ...
                name: 'Красная Вуаль',
                leader: 'Кантис',
                ranks: ['Нейтралитет', 'Незнакомец', 'Освобождённый', 'Преданный', 'Фанатик'],
                rewards: ['Аугменты Варфреймов', 'Оружие синдиката', 'Арчвинг моды'],
                howToRank: 'Ношение сигила, задания синдиката, медальоны'
            },
            {
