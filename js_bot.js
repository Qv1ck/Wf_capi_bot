    ...
    deimos: {
        ...
        syndicates: [
            ...
            },
            {
                ...
                howToRank: 'Архивы Энтрати, задания Санктум Анатомики'
            }
        ]
    },
    zariman: {
        ...
        syndicates: [
            {
                ...
                rewards: ['Части Джайры', 'Части Воруны', 'Инкарнон генезисы', 'Мистики'],
                howToRank: 'Задания на Заримане (Каскад, Потоп, Армагеддон), сдача перьев'
            }
        ]
    },
    relay: {
