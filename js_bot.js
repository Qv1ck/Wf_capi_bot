    ...
    cetus: {
        ...
        syndicates: [
            ...
            },
            {
                ...
                leader: 'Накак',
                location: 'Накак, Цетус',
                ranks: ['Нет рангов'],
                rewards: ['Декорации', 'Маски', 'Скины оружия', 'Косметика'],
                howToRank: 'Покупка за кредиты и ресурсы Равнин'
            }
        ]
    },
    fortuna: {
        ...
        syndicates: [
            {
                ...
                name: 'Глас Солярис',
                leader: 'Юдико',
                ranks: ['Нейтрал', 'Беженец', 'Работник', 'Оперативник', 'Старейшина'],
            ...
            },
            {
                ...
                ranks: ['Нейтрал', 'Агент', 'Рука', 'Инструмент', 'Голос'],
            ...
            },
            {
                ...
                name: 'Дети Труб',
                leader: 'Ротки',
                location: 'Вентиляция, Фортуна',
                ranks: ['Чужак', 'Любитель', 'Про', 'Горячая штучка', 'Легенда'],
            ...
            },
            {
                ...
                name: 'Мракомор',
                leader: 'Мракомор',
                location: 'Фортуна (Рэйлджек)',
                ranks: ['Нейтрал', 'Знакомый', 'Доверенный', 'Партнёр', 'Семья'],
                rewards: ['Части Nokko', 'Моды', 'Ресурсы'],
                howToRank: 'Миссии Мракомора (Рэйлджек с Фортуны)'
            }
        ]
    },
    deimos: {
        ...
        syndicates: [
            ...
            },
            {
                ...
                rewards: ['Части Цита-09', 'Генезисы Инкарнон', 'Моды', 'Мистики'],
                howToRank: 'Задания в Хёльвании, продажа предметов с заданий'
            }
        ]
    },
    zariman: {
        ...
        syndicates: [
            {
                ...
                name: 'Хранители',
                leader: 'Кавальеро',
                ranks: ['Нейтрал', 'Безбилетник', 'Гость', 'Обитатель', 'Ангел'],
...
bot.action('synd_back', async (ctx) => {
    const keyboard = Markup.inlineKeyboard([
        ...
        [Markup.button.callback('🦠 Деймос', 'synd_deimos'), Markup.button.callback('🔮 Зариман', 'synd_zariman')],
        [Markup.button.callback('⚔️ Реле', 'synd_relay'), Markup.button.callback('🌍 Земля', 'synd_earth')],
        [Markup.button.callback('📻 Глобальные', 'synd_global')]
    ]);
