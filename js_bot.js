...
const augmentMods = {
	...
	"Chroma": {
        ...
        3: { name: "Броня Защитника | Дразнящее Возмездие ", syndicates: ["Последовательность Перрина", "Цефалон Суда"] },
	...
	"Ember": {
        ...
        3: { name: "Очищающее Пламя | Исцеляющее Пламя", syndicates: ["Красная Вуаль", "Стальной Меридиан | Конклав"] },
        4: { name: "Экзотермика", syndicates: ["Конклав"] }
    },
	"Equinox": {
        1: { name: "Галерея Злобы", syndicates: ["Арбитры Гексиса", "Цефалон Суда"] },
        2: { name: "Взрывной Обман", syndicates: ["Арбитры Гексиса", "Цефалон Суда"] },
