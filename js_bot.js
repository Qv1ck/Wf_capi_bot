...
function formatWarframeInfo(info) {
    ...
    if (info.abilities && info.abilities.length > 0) {
        ...
        info.abilities.forEach((ability, index) => {
            ...
            // Проверяем есть ли аугмент для этой способности
            const augment = info.augments && info.augments[slot];
            
            if (augment) {
                const syndicatesStr = augment.syndicates.join(' | ');
                message += `${slot}. ${abilityName} 🔧 _${augment.name}_ ← ${syndicatesStr}\n`;
            } else {
        ...
        syndicates: [
            {
                ...
                rewards: ['Оружие синдиката', 'Арчвинг моды'],
                augments: 'Атлас, Воруна, Гаруда, Грендель, Заку, Кора, Корвекс, Куллерво, Миса, Нидус, Нова, Нэчжа, Оберон, Рино, Сарина, Цитрина, Фрост, Экскалибур, Эмбер',
            ...
            },
            {
                ...
                rewards: ['Оружие синдиката', 'Арчвинг моды'],
                augments: 'Баруук, Вольт, Вуконг, Гара, Гаусс, Джайра, Джейд, Инарос, Комея, Лимбо, Локи, Мираж, Никс, Протея, Стинакс, Харроу, Эквинокс, Экскалибур, Эш',
                howToRank: 'Ношение сигила, задания синдиката, медальоны'
            },
            {
                id: 'cephalon_suda',
                ...
                rewards: ['Оружие синдиката', 'Арчвинг моды'],
                augments: 'Банши, Висп, Вобан, Гидроид, Заку, Ивара, Корвекс, Калибан, Лимбо, Мираж, Нова, Нэчжа, Октавия, Ревенант, Севагот, Фрост, Хильдрин, Хрома, Ярели',
                howToRank: 'Ношение сигила, задания синдиката, медальоны'
            },
            {
                id: 'perrin',
                ...
                rewards: ['Оружие синдиката', 'Арчвинг моды'],
                augments: 'Банши, Валькирия, Вобан, Гаусс, Дагас, Джайра, Ивара, Инарос, Калибан, Мэг, Некрос, Нидус, Протея, Ревенант, Рино, Севагот, Тринити, Хильдрин, Хрома',
                howToRank: 'Ношение сигила, задания синдиката, медальоны'
            },
            {
                id: 'red_veil',
                ...
                rewards: ['Оружие синдиката', 'Арчвинг моды'],
                augments: 'Атлас, Вольт, Гаруда, Грендель, Дагас, Джейд, Зефир, Кора, Лавос, Локи, Миса, Некрос, Сарина, Титания, Харроу, Цитрина, Эмбер, Эш',
                howToRank: 'Ношение сигила, задания синдиката, медальоны'
            },
            {
                id: 'new_loka',
                ...
                rewards: ['Оружие синдиката', 'Арчвинг моды'],
                augments: 'Баруук, Валькирия, Висп, Вуконг, Гара, Гидроид, Зефир, Комея, Куллерво, Лавос, Мэг, Никс, Оберон, Октавия, Стинакс, Титания, Тринити, Эквинокс, Ярели',
                howToRank: 'Ношение сигила, задания синдиката, медальоны'
            },
            {
                id: 'simaris',
